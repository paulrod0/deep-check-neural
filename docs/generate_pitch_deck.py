#!/usr/bin/env python3
"""
Deep-Check Investor Pitch Deck Generator
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "deep_check_pitch_deck.pdf")
...
def slide_cover(c):
    ...
    c.drawString(MARGIN, 55, "Confidencial  |  Marzo 2026")
...
def slide_closing(c):
    ...
    c.setFillColor(GRAY_DARK)
    c.setFont("Helvetica", 8)
    c.drawCentredString(W / 2, 30, "Confidencial  |  Marzo 2026  |  Pre-Seed 150K EUR")
...
def main():
    ...
    c.setTitle("Deep-Check - Investor Pitch Deck - Pre-Seed Round - March 2026")
    c.setAuthor("Pablo Lopez Rodriguez")
    c.setSubject("Pre-Seed Investment Round - 150K EUR")
