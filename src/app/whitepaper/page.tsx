      ...
      <div className={styles.container}>
        ...
        <S title="4. Module 3 — Document Forensics">
          ...
          <p>
            ...
            This leaves a characteristic periodicity in the DCT coefficient histograms — the so-called &ldquo;double compression ghost&rdquo;.
          ...
          <p>
            ...
            The log-likelihood ratio (LLR) per signal is accumulated, and the posterior probability of manipulation is computed
            from a conservative prior P(manipulated) = 0.05:
          </p>
          <div className={wpStyles.formula}>
