...
|---------|--------|--------|-----|-----|-------|-------|----|--------|
| deepfake_test | 10,000 | 10,000 | 1.0000 | 0.0004 | 0.0004 | 0.0004 | 34.26 | 96 |

## Industry Comparison

| System | Best AUC | Best EER | Liveness | Architecture |
|--------|---------|---------|----------|-------------|
| **Deep-Check v3** | **1.0000** | **0.0004** | Passive (7 checks) + 6-layer ensemble | EfficientNet-B4 + FreqV2 |
...
| Metric | Value |
|--------|-------|
| frr_at_far_0_001 | 0.0002 (0.02%) |
| frr_at_far_0_01 | 0.0000 (0.00%) |
| frr_at_far_0_05 | 0.0000 (0.00%) |
| far_at_frr_1pct | 0.0001 (0.01%) |
